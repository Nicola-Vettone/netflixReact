...
class Galleriy3 extends Component {
  state = {
    films: [],
  };
  ...
  fetchImg = async () => {
    try {
      const response = await fetch("http://www.omdbapi.com/?apikey=d9bd69eb&s=Avengers");
      if (!response.ok) {
